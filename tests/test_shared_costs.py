...
MOCK_WEAPON_DB = {
    "rune sword": {
        ...
        "speed": 2.4,
        "cost": 30.0,
        "bonus": {"stab": 38, "slash": 26, "crush": -2},
    },
    "rune mace": {
        "atk_req": 40,
        "str": 36,
        "speed": 2.4,
        "cost": 30.0,
        "bonus": {"stab": 20, "slash": -2, "crush": 39},
    },
}


class TestSharedCosts(unittest.TestCase):
    def test_simple_shared_cost(self) -> None:
        """
        ...
        with (
            patch("osrs_dps.cli.AMULETS_DB", {"none": MOCK_AMMY_DB["none"]}),
    ...
    def test_nested_shared_costs(self) -> None:
        """
        ...
        with (
            patch("osrs_dps.cli.AMULETS_DB", mock_ammys),
            patch("osrs_dps.cli.WEAPON_DB", MOCK_WEAPON_DB),
        ):
            result = optimize_melee.solve(
                req_graph=graph,
    ...
    def test_independent_costs(self) -> None:
        """
